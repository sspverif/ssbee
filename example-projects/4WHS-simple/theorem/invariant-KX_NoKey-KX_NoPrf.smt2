...
(define-fun invariant
  ...
  (let ((left-game-pkg (<game-Hybrid1-<$<!n!>$>-pkgstate-KX> left-game))
    ...
    (let ((left-LTK (<pkg-state-KX_NoKey-<$<!n!>$>-LTK> left-game-pkg))
          (left-State (<pkg-state-KX_NoKey-<$<!n!>$>-State> left-game-pkg))
          (left-Fresh (<pkg-state-KX_NoKey-<$<!n!>$>-Fresh> left-game-pkg))
          (left-RevTested (<pkg-state-KX_NoKey-<$<!n!>$>-RevTested> left-game-pkg))
          (left-H (<pkg-state-KX_NoKey-<$<!n!>$>-H> left-game-pkg))
          (left-kid (<pkg-state-KX_NoKey-<$<!n!>$>-kid_> left-game-pkg))
          (left-ctr (<pkg-state-KX_NoKey-<$<!n!>$>-ctr_> left-game-pkg))
          ;;
